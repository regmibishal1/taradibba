"""
Django settings for taradibba project.
...
PROJECT_DIR = os.path.join(BASE_DIR, "taradibba")
...
ROOT_URLCONF = 'taradibba.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(PROJECT_DIR, "template")],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'taradibba.wsgi.application'
